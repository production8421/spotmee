...
final class HomeEarnSectionImageImporter
{
    /**
     * Copy a raster image from the private media library to the public “home earn” folder.
     *
    ...
    public static function copyToPublic(MediaAsset $asset): ?string
    {
        ...
        $newPath = 'frontend/home-earn/'.(string) Str::uuid().'.'.$ext;
