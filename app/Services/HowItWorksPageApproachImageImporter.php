...
final class HowItWorksPageApproachImageImporter
{
    /**
     * Copy a raster image from the private media library to the public How it works page “approach” folder.
     *
     * @return non-empty-string|null Relative path on the public disk, or null on failure.
     */
    public static function copyToPublic(MediaAsset $asset): ?string
    {
        ...
        $newPath = 'frontend/how-it-works-page/approach/'.(string) Str::uuid().'.'.$ext;
