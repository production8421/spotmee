...
final class HomeCommunitySectionImageImporter
{
    /**
     * Copy a raster image from the private media library to the public “home community” folder.
     *
    ...
    public static function copyToPublic(MediaAsset $asset): ?string
    {
        ...
        $newPath = 'frontend/home-community/'.(string) Str::uuid().'.'.$ext;
