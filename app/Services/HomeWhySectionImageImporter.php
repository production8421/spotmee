...
final class HomeWhySectionImageImporter
{
    /**
     * Copy a raster image from the private media library to the public “home why” folder.
     *
    ...
    public static function copyToPublic(MediaAsset $asset): ?string
    {
        ...
        $newPath = 'frontend/home-why/'.(string) Str::uuid().'.'.$ext;
