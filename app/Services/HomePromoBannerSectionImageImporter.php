...
final class HomePromoBannerSectionImageImporter
{
    /**
     * Copy a raster image from the private media library to the public “home promo banner” folder.
     *
    ...
    public static function copyToPublic(MediaAsset $asset): ?string
    {
        ...
        $newPath = 'frontend/home-promo-banner/'.(string) Str::uuid().'.'.$ext;
