...
final class HowItWorksStepImageImporter
{
    /**
     * Copy a raster image from the private media library to the public “how it works” folder.
     *
    ...
    public static function copyToPublic(MediaAsset $asset): ?string
    {
        ...
        $newPath = 'frontend/how-it-works/'.(string) Str::uuid().'.'.$ext;
