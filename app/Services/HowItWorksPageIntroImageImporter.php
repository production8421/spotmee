...
final class HowItWorksPageIntroImageImporter
{
    /**
     * Copy a raster image from the private media library to the public How it works page intro folder.
     *
    ...
    public static function copyToPublic(MediaAsset $asset): ?string
    {
        ...
        $newPath = 'frontend/how-it-works-page/intro/'.(string) Str::uuid().'.'.$ext;
